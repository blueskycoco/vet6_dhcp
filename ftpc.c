...
uint8_t FTP_destip[4] = {47, 93, 48, 167};	// For FTP client examples; destination network info
uint16_t FTP_destport = 1721;						// For FTP client examples; destination network info
